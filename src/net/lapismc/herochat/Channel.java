...
public interface Channel {
    ...
    void addWorld(String paramString);
    ...
    void setWorlds(Set<String> paramSet);

    boolean hasWorld(String paramString);

    boolean hasWorld(World paramWorld);

    boolean isBanned(String paramString);

    boolean isCrossWorld();

    void setCrossWorld(boolean paramBoolean);
    ...
    void removeWorld(String paramString);
