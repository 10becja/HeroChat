...
import net.lapismc.herochat.command.CommandHandler;
import net.lapismc.herochat.command.commands.*;
...
public class Herochat extends JavaPlugin {
    ...
    static void setLocale(Locale locale)
        ...
        messages = ResourceBundle.getBundle("net.lapismc.herochat.resources.Messages", locale);
        if (messages == null) {
            throw new ClassNotFoundException("net.lapismc.herochat.resources.Messages");
        }
    }
